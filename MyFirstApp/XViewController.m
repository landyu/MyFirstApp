...
//    }
    ...
    if (sender.on)
    {
        ...
        NSData* req_data =[[[NSData alloc]initWithData:[@"{\"type\":\"EIBS\",\"addr\":\"0/0/0\",\"value\":1}" dataUsingEncoding:NSUTF8StringEncoding]] autorelease];
        
        char jasonHeader[8] = {0,0,0,0,[req_data length],0,0,0};
        NSMutableData * reqPak = [[[NSMutableData alloc] initWithBytes: jasonHeader length:8]autorelease];
